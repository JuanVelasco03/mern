...
export default function Administradores(){
  ...
  const dataAdministradores = async() => {
    ...
    console.log('getAdministradores:', getAdministradores)
  }
              ...
              <div className="col-lg-12">
                <div className="card card-primary card-outline">
                  <div className="card-header">
                    <button className="btn btn-primary mt-2 mb-2" data-toggle="modal" data-target="#crearAdmin">Crear nuevo administrador</button>
...
const getData = () => {
  const url = `${rutaApi}/mostrar-administradores`;
